      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 hero-text">
            ...
            <p><b>Harga: </b>Mulai dari Rp 2.799.000</p>
          </div>
          <div class="col-md-6 text-center">
            <img src="ap4.png" alt="4" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section-spesifikasi text-white" id="spesifikasi">
      ...
      <div class="parent">
          ...
          <table class="table-table table-sm table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td>AirPods(Masing-Masing): Tinggi 30,2 mm; Lebar 18,3 mm; Tebal 18,1 mm; Berat 4,3 gram</td>
                <td>Waktu dengar hingga 4-5 jam, waktu bicara hingga 4,5 jam/td>
              </tr>
              <tr>
                ...
                <td>Casing : Tinggi 46,2 mm; Lebar 50,1 mm; Tebal 21,7 mm; Berat 34,7 gram</td>
                <td>Bluetooth 5.3</td>
              </tr>
              <tr>
        ...
        <div class="div5 table-responsive">
          <table class="table-table table-sm table-striped">
            <tr>
              ...
              <td>Audio dengar langsung, Level headphone, akomodasi headphone</td>
            </tr>
            <tr>
              <th>Ketahanan & AKsesibilitas</th>
              <td>Tahan debu, air dan keringat(IP54), Fitur aksesibilitas membantu penyandang disabilitas memasimalkan AirPods Max</td>
            </tr>
            <tr>
              <th>Isi Kotak</th>
              <td>AirPods 4 dengan peredam kebisingan aktif, Casing pengisian daya (USB-C), Dokumentasi; Kabel pengisian daya USB-C dijual terpisah</td>
            </tr>
          </table>
        </div>
        ...
        <div class="div7 text-center">
          <p>•	AirPods 4 dengan Peredam Kebisingan Aktif menawarkan pengalaman mendengarkan yang mendalam dengan fitur-fitur canggih seperti Peredam Kebisingan Aktif, Audio Spasial Personal, dan kontrol sentuh yang intuitif.</p>
        </div>
      </div>
