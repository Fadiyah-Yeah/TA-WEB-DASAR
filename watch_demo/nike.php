...
<section class="section-hero">
  ...
  <section class="section-spesifikasi text-white" id="spesifikasi">
    ...
    <div class="parent">
      <div class="card div1"><b>Bahan & Warna: </b>Casing aluminium; tersedia dalam warna Perak dan Abu-abu.</div>
      <div class="card div4"><b>Casing:</b>Tersedia dalam ukuran 44 mm dan 40 mm.</div>
      <div class="card div5"><b>Layar: </b>Layar Retina LTPO OLED; layar kaca Ion-X; kecerahan hingga 1.000 nit.</div>
  ...
  <section class="section-fitur">
    ...
    <div class="workflow">
      <div class="step"><b>Kesehatan & Kebugaran</b><br> Pelacakan aktivitas; deteksi jatuh; pelacakan siklus menstruasi; aplikasi EKG; pemberitahuan detak jantung rendah dan tinggi; pemberitahuan ritme tidak teratur.</div>
      <div class="step"><b>Keselamatan</b><br> SOS darurat dan deteksi jatuh.</div>
      <div class="step"><b>Fitur Lingkungan</b> <br> Casing aluminium 100% daur ulang; penggunaan bahan daur ulang lainnya.</div>
    </div>
  </section>
  ...
  <section class="section-kesimpulan text-center text-white">
    ...
    <p class="text-center">Apple Watch Nike menawarkan fitur-fitur esensial Apple Watch dengan desain sporty dan aplikasi Nike Run Club, cocok untuk pengguna yang aktif dan menyukai olahraga lari.</p>
  </section>
  </div>
