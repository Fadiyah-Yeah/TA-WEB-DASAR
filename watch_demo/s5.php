...
<section class="section-hero">
  ...
  <section class="section-spesifikasi text-white" id="spesifikasi">
    ...
    <div class="parent">
      ...
      <div class="card div5"><b>Layar: </b>Layar Retina LTPO OLED Always-On dengan kecerahan hingga 1.000 nit.</div>
      <div class="card div6"><b>Chip: </b>Chip S5 SiP dengan prosesor dual-core 64-bit.</div>
      <div class="card div7"><b>Sensor: </b>Sensor detak jantung optik generasi ke-2, akselerometer, gyroscope, kompas, dan altimeter.</div>
      <div class="card div8"><b>Konektivitas: </b>Wi-Fi 802.11b/g/n 2,4GHz, Bluetooth 5.0, GPS/GNSS, dan model GPS + Seluler.</div>
  ...
  <section class="section-kesimpulan text-center text-white">
    ...
    <p class="text-center">Apple Watch Series 5 memperkenalkan layar Always-On dan fitur-fitur kesehatan penting, menjadikannya pilihan yang solid bagi pengguna yang menginginkan smartwatch dengan fitur</p>
  </section>
  </div>
