...
<section class="section-hero">
    ...
    <div class="row align-items-center">
      <div class="col-md-6 hero-text">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="#">Apple Watch SE (Generasi ke-2)</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Series 10</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Series 9</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Ultra</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Series 5</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Ultra 2</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Nike</a></li>
          <li><a class="dropdown-item" href="#">Apple Watch Series 4</a></li>
        </ul>
        <p><b>Harga: </b>Mulai dari Rp 6.096.027.</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="watch-4.png" alt="4" class="img-fluid">
      </div>
    </div>
  </div>
</section>
  ...
  <section class="section-spesifikasi text-white" id="spesifikasi">
    ...
    <div class="parent">
      <div class="card div1"><b>Bahan & Warna: </b>Casing aluminium dan stainless steel; tersedia dalam berbagai warna termasuk Silver dan Space Gray.</div>
      <div class="card div4"><b>Casing:</b>Tersedia dalam ukuran 44 mm dan 40 mm.</div>
      <div class="card div5"><b>Layar: </b>Layar Retina LTPO OLED dengan Force Touch; kecerahan hingga 1.000 nit; layar kaca Ion-X pada casing aluminium; layar kristal safir pada casing baja tahan karat.</div>
      <div class="card div6"><b>Chip: </b>S4 SiP dengan prosesor dual-core 64-bit; chip nirkabel W3.</div>
      <div class="card div7"><b>Sensor: </b>Sensor jantung elektrik; sensor jantung optik generasi kedua; akselerometer yang ditingkatkan hingga 32 g-force; giroskop yang ditingkatkan; sensor cahaya sekitar.</div>
      <div class="card div8"><b>Konektivitas: </b>Wi-Fi; Bluetooth 5.0; GPS/GNSS; altimeter barometrik.</div>
      <div class="card div9"><b>Daya & Kekuatan Baterai: </b>Hingga 18 jam penggunaan normal.</div>
  ...
  <section class="section-fitur">
    ...
    <div class="workflow">
      <div class="step"><b>Kesehatan & Kebugaran</b><br> Pelacakan aktivitas, deteksi jatuh, dan pelacakan siklus menstruasi; aplikasi EKG; pemberitahuan detak jantung rendah dan tinggi; pemberitahuan ritme tidak teratur.</div>
      <div class="step"><b>Keselamatan</b><br> SOS darurat dan deteksi jatuh.</div>
      <div class="step"><b>Fitur Lingkungan</b> <br>Casing aluminium 100% daur ulang.</div>
    </div>
  </section>
  ...
  <section class="section-kesimpulan text-center text-white">
    ...
    <p class="text-center">Apple Watch Series 4 memperkenalkan layar yang lebih besar dan fitur-fitur kesehatan penting, menjadikannya pilihan yang solid bagi pengguna yang menginginkan smartwatch dengan fitur kesehatan dan keselamatan yang lengkap.</p>
  </section>
