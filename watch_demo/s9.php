...
<section class="section-hero">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 hero-text">
        ...
        <p><b>Harga: </b>Mulai dari Rp 5.199.000</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="s9.png" alt="4" class="img-fluid">
      </div>
    </div>
  </div>
</section>
  ...
  <section class="section-spesifikasi text-white" id="spesifikasi">
    ...
    <div class="parent">
      <div class="card div1"><b>Bahan & Warna: </b>Casing aluminium dan stainless steel; tersedia dalam berbagai warna termasuk Midnight dan Silver.</div>
      <div class="card div4"><b>Casing:</b>Tersedia dalam ukuran 45 mm dan 41 mm.</div>
      <div class="card div5"><b>Layar: </b>Layar Retina LTPO OLED Always-On dengan kecerahan hingga 2.000 nit.</div>
      <div class="card div6"><b>Chip: </b>Chip S9 SiP dengan prosesor dual-core 64-bit.</div>
  ...
  <section class="section-kesimpulan text-center text-white">
    ...
    <p class="text-center">Apple Watch Series 9 menawarkan keseimbangan antara fitur-fitur canggih dan harga yang lebih terjangkau dibandingkan Series 10, cocok bagi pengguna yang menginginkan smartwatch dengan performa tinggi dan fitur kesehatan lengkap.</p>
  </section>
  </div>
