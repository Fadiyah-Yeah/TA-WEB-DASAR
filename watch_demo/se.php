...
<section class="section-hero">
  ...
  <section class="section-spesifikasi text-white" id="spesifikasi">
    ...
    <div class="parent">
      <div class="card div1"><b>Bahan & Warna: </b>Casing aluminium; tersedia dalam warna Midnight, Starlight, dan Silver.</div>
      <div class="card div4"><b>Casing:</b>Tersedia dalam ukuran 44 mm dan 40 mm.</div>
      <div class="card div5"><b>Layar: </b>Layar Retina LTPO OLED.</div>
      <div class="card div6"><b>Chip: </b>Chip S8 SiP dengan prosesor dual-core 64-bit.</div>
      <div class="card div7"><b>Sensor: </b>Sensor detak jantung optik generasi ke-2, akselerometer, gyroscope, kompas, dan altimeter.</div>
      <div class="card div8"><b>Konektivitas: </b>Wi-Fi 802.11b/g/n 2,4GHz, Bluetooth 5.3, GPS/GNSS, dan model GPS + Seluler.</div>
  ...
  <section class="section-fitur">
    ...
    <div class="workflow">
      <div class="step"><b>Kesehatan & Kebugaran</b><br> Pelacakan aktivitas, deteksi jatuh, dan pelacakan siklus menstruasi.</div>
  ...
  <section class="section-kesimpulan text-center text-white">
    ...
    <p class="text-center">Apple Watch SE (Generasi ke-2) menawarkan fitur-fitur esensial Apple Watch dengan harga yang lebih terjangkau, cocok untuk pengguna baru atau mereka yang menginginkan perangkat wearable fungsional tanpa fitur-fitur premium.</p>
  </section>
  </div>
